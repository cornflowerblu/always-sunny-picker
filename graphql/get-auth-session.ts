...
export const getAuthSession = async (variables: GetAuthSessionInput, requestHeaders: {}) =>
  <GetAuthSessionOutput>await client.gqlClient.request(query, variables, requestHeaders)
